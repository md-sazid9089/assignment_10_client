    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm">
      <div className="relative w-full max-w-xl rounded-3xl bg-[#070b1b] border border-white/10 shadow-2xl p-6 text-slate-100">
        ...
        <div className="space-y-3">
          <span className="inline-block rounded-full bg-blue-500/90 dark:bg-purple-500/90 px-3 py-1 text-xs font-semibold text-white shadow-lg mb-2">
            {artwork.category}
          </span>
          ...
          <div className="flex items-center gap-3 text-xs text-slate-400 mb-2">
            <span className="flex h-9 w-9 items-center justify-center rounded-full bg-gradient-to-br from-blue-500 to-cyan-500 dark:from-purple-500 dark:to-pink-500 text-sm font-semibold text-white">
          ...
          <div className="flex items-center justify-between text-xs mb-2">
            ...
            <span className="flex items-center gap-1 text-cyan-400 dark:text-pink-400">
